...
class TestKnn(unittest.TestCase):
	...
	print '**********2**********'
	print '>>>' + repr(b2)
        self.assertAlmostEqual(b2[0], -0.30097640098415529)
        self.assertAlmostEqual(b2[1], 1.0)
        self.assertAlmostEqual(b2[2], -0.05097640098415529)
        self.assertAlmostEqual(b2[3], -1.1529292029524658)
        self.assertAlmostEqual(b2[4], -0.85195280196831058)
    ...
    def test_unreg(self):
        ...
        self.assertAlmostEqual(b2[0], -0.47068776924864364)
        self.assertAlmostEqual(b2[1], 2.0)
        self.assertAlmostEqual(b2[2], 0.5293122307513564)
        self.assertAlmostEqual(b2[3], -2.4120633077459308)
        self.assertAlmostEqual(b2[4], -3.8827510769945746)
